...
public class CursoEditar extends javax.swing.JFrame {
     ...
     */
    public CursoEditar(br.com.ifba.curso.entity.Curso cursoParaEditar) {
    initComponents();
    ...
    if (cursoParaEditar != null) {
        ...
        // Preenchendo os campos com os nomes das suas variáveis
        ...
        // String.valueOf converte o Integer para texto para o campo de texto
    ...
    private void initComponents() {
        ...
        pnlcorpoCadastraCurso.add(txtnomeCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 110, 450, 44));
        ...
        pnlcorpoCadastraCurso.add(txtcodigoCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 180, 450, 43));
        ...
        pnlcorpoCadastraCurso.add(btnsalvaNovoCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 400, 240, 70));
        pnlcorpoCadastraCurso.add(txtVagas, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 310, 450, 50));

        getContentPane().add(pnlcorpoCadastraCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, 540));
